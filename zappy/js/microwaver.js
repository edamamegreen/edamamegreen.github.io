...
document.write("<script>if (typeof goog != \"undefined\") { goog.require(\"figwheel.connect.build_ui\"); }</script>");
document.write('<script>goog.require("com.nicki.microwaver.main");</script>');