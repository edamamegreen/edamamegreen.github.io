...
var x__36605__auto__ = (((x == null))?null:x);
var m__36606__auto__ = (sablono.util.to_str[goog.typeOf(x__36605__auto__)]);
if(!((m__36606__auto__ == null))){
return m__36606__auto__.call(null,x);
} else {
var m__36606__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__36606__auto____$1 == null))){
return m__36606__auto____$1.call(null,x);
} else {
...
var x__36605__auto__ = (((x == null))?null:x);
var m__36606__auto__ = (sablono.util.to_uri[goog.typeOf(x__36605__auto__)]);
if(!((m__36606__auto__ == null))){
return m__36606__auto__.call(null,x);
} else {
var m__36606__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__36606__auto____$1 == null))){
return m__36606__auto____$1.call(null,x);
} else {
...
var len__37108__auto___75206 = arguments.length;
var i__37109__auto___75207 = (0);
while(true){
if((i__37109__auto___75207 < len__37108__auto___75206)){
args__37115__auto__.push((arguments[i__37109__auto___75207]));

var G__75208 = (i__37109__auto___75207 + (1));
i__37109__auto___75207 = G__75208;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__37116__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq75205){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq75205));
});
...
var vec__75212 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__75213 = cljs.core.seq.call(null,vec__75212);
var first__75214 = cljs.core.first.call(null,seq__75213);
var seq__75213__$1 = cljs.core.next.call(null,seq__75213);
var first_word = first__75214;
var words = seq__75213__$1;
...
var G__75216 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__75216,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__75216;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__75217_SHARP_){
if(typeof p1__75217_SHARP_ === 'string'){
return p1__75217_SHARP_;
} else {
return cljs.core.seq.call(null,p1__75217_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__35887__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1512968106372