...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__76965 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__76965,kvps);
} else {
return G__76965;
}
})());
...
var map__76968 = rec;
var map__76968__$1 = ((((!((map__76968 == null)))?((((map__76968.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76968.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76968):map__76968);
var depth = cljs.core.get.call(null,map__76968__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__76968__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__76971 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__76971__$1 = (((G__76971 == null))?null:cljs.core.persistent_BANG_.call(null,G__76971));
if((G__76971__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__76971__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__76972){
var vec__76977 = p__76972;
var seq__76978 = cljs.core.seq.call(null,vec__76977);
var first__76979 = cljs.core.first.call(null,seq__76978);
var seq__76978__$1 = cljs.core.next.call(null,seq__76978);
var frame = first__76979;
var frames = seq__76978__$1;
...
var results = (function (){var G__76980 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__76980,kvps);
} else {
return G__76980;
}
})();
...
var recursion = cljs.core.get.call(null,map__76983__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__76983__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_76985 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_76985){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_76985,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_76985))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__76987){
var vec__76995 = p__76987;
var seq__76996 = cljs.core.seq.call(null,vec__76995);
var first__76997 = cljs.core.first.call(null,seq__76996);
var seq__76996__$1 = cljs.core.next.call(null,seq__76996);
var parent = first__76997;
var frames = seq__76996__$1;
...
var found = cljs.core.not_empty.call(null,(function (){var G__76998 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__76998);
} else {
return G__76998;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__76995,seq__76996,first__76997,seq__76996__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__76995,seq__76996,first__76997,seq__76996__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__76995,seq__76996,first__76997,seq__76996__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__76995,seq__76996,first__76997,seq__76996__$1,parent,frames))
);
...
var as_value = (function (){var G__76999 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__76999,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__76995,seq__76996,first__76997,seq__76996__$1,parent,frames){
return (function (p1__76986_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__76986_SHARP_]);
});})(G__76999,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__76995,seq__76996,first__76997,seq__76996__$1,parent,frames))
,G__76999);
} else {
return G__76999;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__77000 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__77000);
} else {
return G__77000;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__77001 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__77001,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__77001;
}
})());
...
var vec__77005 = spec;
var attr_key = cljs.core.nth.call(null,vec__77005,(0),null);
var opts = cljs.core.nth.call(null,vec__77005,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__77008){
var vec__77009 = p__77008;
var k = cljs.core.nth.call(null,vec__77009,(0),null);
var v = cljs.core.nth.call(null,vec__77009,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__77012){
var vec__77016 = p__77012;
var seq__77017 = cljs.core.seq.call(null,vec__77016);
var first__77018 = cljs.core.first.call(null,seq__77017);
var seq__77017__$1 = cljs.core.next.call(null,seq__77017);
var frame = first__77018;
var frames = seq__77017__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__77019){
var vec__77026 = p__77019;
var seq__77027 = cljs.core.seq.call(null,vec__77026);
var first__77028 = cljs.core.first.call(null,seq__77027);
var seq__77027__$1 = cljs.core.next.call(null,seq__77027);
var frame = first__77028;
var frames = seq__77027__$1;
...
var vec__77029 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__77029,(0),null);
var datoms = cljs.core.nth.call(null,vec__77029,(1),null);
...
var map__77035 = frame;
var map__77035__$1 = ((((!((map__77035 == null)))?((((map__77035.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__77035.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__77035):map__77035);
var attr = cljs.core.get.call(null,map__77035__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__77035__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__77037 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__77037,attr,eid);
} else {
return G__77037;
}
})();
...
var map__77040 = frame;
var map__77040__$1 = ((((!((map__77040 == null)))?((((map__77040.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__77040.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__77040):map__77040);
var eid = cljs.core.get.call(null,map__77040__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__77040__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__77042){
while(true){
var vec__77046 = p__77042;
var seq__77047 = cljs.core.seq.call(null,vec__77046);
var first__77048 = cljs.core.first.call(null,seq__77047);
var seq__77047__$1 = cljs.core.next.call(null,seq__77047);
var frame = first__77048;
var frames = seq__77047__$1;
var temp__6751__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__6751__auto__){
var eids = temp__6751__auto__;
...
var G__77049 = db;
var G__77050 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__77049;
p__77042 = G__77050;
continue;
}
...
while(true){
var G__77057 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__77057) {
case "expand":
var G__77064 = db;
var G__77065 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__77064;
frames = G__77065;
continue;
...
case "expand-rev":
var G__77066 = db;
var G__77067 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__77066;
frames = G__77067;
continue;
...
case "pattern":
var G__77068 = db;
var G__77069 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__77068;
frames = G__77069;
continue;
...
case "recursion":
var G__77070 = db;
var G__77071 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__77070;
frames = G__77071;
continue;
...
break;
case "done":
var vec__77058 = frames;
var seq__77059 = cljs.core.seq.call(null,vec__77058);
var first__77060 = cljs.core.first.call(null,seq__77059);
var seq__77059__$1 = cljs.core.next.call(null,seq__77059);
var f = first__77060;
var remaining = seq__77059__$1;
var result = (function (){var G__77061 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__77061);
} else {
return G__77061;
}
})();
...
var G__77072 = db;
var G__77073 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__77062 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__77062,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__77062;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__77074_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__77074_SHARP_);
})),eids);
...
//# sourceMappingURL=pull_api.js.map?rel=1512968114173