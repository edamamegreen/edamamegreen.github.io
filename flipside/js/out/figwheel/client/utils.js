...
var or__35887__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj82519 = {"detail":data};
return obj82519;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__35875__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__35875__auto__)){
var and__35875__auto____$1 = (window["CustomEvent"]);
...
var args82524 = [];
var len__37108__auto___82530 = arguments.length;
var i__37109__auto___82531 = (0);
while(true){
if((i__37109__auto___82531 < len__37108__auto___82530)){
args82524.push((arguments[i__37109__auto___82531]));

var G__82532 = (i__37109__auto___82531 + (1));
i__37109__auto___82531 = G__82532;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args82524.length)].join('')));
...
var f = (function (){var pred__82527 = cljs.core._EQ_;
var expr__82528 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__82527.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__82528))){
return ((function (pred__82527,expr__82528){
return (function (p1__82520_SHARP_){
return console.warn(p1__82520_SHARP_);
});
;})(pred__82527,expr__82528))
} else {
if(cljs.core.truth_(pred__82527.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__82528))){
return ((function (pred__82527,expr__82528){
return (function (p1__82521_SHARP_){
return console.debug(p1__82521_SHARP_);
});
;})(pred__82527,expr__82528))
} else {
if(cljs.core.truth_(pred__82527.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__82528))){
return ((function (pred__82527,expr__82528){
return (function (p1__82522_SHARP_){
return console.error(p1__82522_SHARP_);
});
;})(pred__82527,expr__82528))
} else {
return ((function (pred__82527,expr__82528){
return (function (p1__82523_SHARP_){
return console.log(p1__82523_SHARP_);
});
;})(pred__82527,expr__82528))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__82534){
var map__82537 = p__82534;
var map__82537__$1 = ((((!((map__82537 == null)))?((((map__82537.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82537.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__82537):map__82537);
var opts = map__82537__$1;
var eval_fn = cljs.core.get.call(null,map__82537__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__82539_SHARP_){
return new_def.callback(p1__82539_SHARP_);
});})(new_def))
);
...
return (function (p__82540){
var vec__82541 = p__82540;
var ky = cljs.core.nth.call(null,vec__82541,(0),null);
var v = cljs.core.nth.call(null,vec__82541,(1),null);
...
var args82544 = [];
var len__37108__auto___82547 = arguments.length;
var i__37109__auto___82548 = (0);
while(true){
if((i__37109__auto___82548 < len__37108__auto___82547)){
args82544.push((arguments[i__37109__auto___82548]));

var G__82549 = (i__37109__auto___82548 + (1));
i__37109__auto___82548 = G__82549;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args82544.length)].join('')));
...
if(cljs.core.truth_((function (){var and__35875__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1512968126768