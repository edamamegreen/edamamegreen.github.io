...
var or__36925__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj52250 = {"detail":data};
return obj52250;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__36913__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__36913__auto__)){
var and__36913__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__52257 = cljs.core._EQ_;
var expr__52258 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__52257.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__52258))){
return ((function (pred__52257,expr__52258){
return (function (p1__52251_SHARP_){
return console.warn(p1__52251_SHARP_);
});
;})(pred__52257,expr__52258))
} else {
if(cljs.core.truth_(pred__52257.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__52258))){
return ((function (pred__52257,expr__52258){
return (function (p1__52252_SHARP_){
return console.debug(p1__52252_SHARP_);
});
;})(pred__52257,expr__52258))
} else {
if(cljs.core.truth_(pred__52257.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__52258))){
return ((function (pred__52257,expr__52258){
return (function (p1__52253_SHARP_){
return console.error(p1__52253_SHARP_);
});
;})(pred__52257,expr__52258))
} else {
return ((function (pred__52257,expr__52258){
return (function (p1__52254_SHARP_){
return console.log(p1__52254_SHARP_);
});
;})(pred__52257,expr__52258))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__52261){
var map__52262 = p__52261;
var map__52262__$1 = ((((!((map__52262 == null)))?((((map__52262.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52262.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52262):map__52262);
var opts = map__52262__$1;
var eval_fn = cljs.core.get.call(null,map__52262__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__52264_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__52266,(0),null);
var v = cljs.core.nth.call(null,vec__52266,(1),null);
...
if(cljs.core.truth_((function (){var and__36913__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1517117191829
