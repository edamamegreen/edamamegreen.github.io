...
}catch (e53025){if((e53025 instanceof Error)){
var e = e53025;
return null;
} else {
throw e53025;
...
var and__36913__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__36913__auto__){
var and__36913__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__36913__auto____$1)){
var and__36913__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__53026){
var map__53027 = p__53026;
var map__53027__$1 = ((((!((map__53027 == null)))?((((map__53027.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53027.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53027):map__53027);
var opts = map__53027__$1;
var retry_count = cljs.core.get.call(null,map__53027__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__53027__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__53027__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__53027__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__5457__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (msg_str){
var temp__5459__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__5459__auto__)){
var msg = temp__5459__auto__;
...
});})(url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__36925__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__37284__auto__ = (10000);
var y__37285__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__5457__auto__,map__53027,map__53027__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1517117192482
