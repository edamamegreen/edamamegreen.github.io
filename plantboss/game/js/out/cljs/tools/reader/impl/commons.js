...
var G__38934 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__38934;
continue;
} else {
return ch;
...
var vec__38935 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__38935,(0),null);
return (match === s);
});
...
var len__38204__auto___38940 = arguments.length;
var i__38205__auto___38941 = (0);
while(true){
if((i__38205__auto___38941 < len__38204__auto___38940)){
args__38211__auto__.push((arguments[i__38205__auto___38941]));

var G__38942 = (i__38205__auto___38941 + (1));
i__38205__auto___38941 = G__38942;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__38212__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq38938){
var G__38939 = cljs.core.first.call(null,seq38938);
var seq38938__$1 = cljs.core.next.call(null,seq38938);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__38939,seq38938__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__38943__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__38943 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__38944__i = 0, G__38944__a = new Array(arguments.length -  1);
while (G__38944__i < G__38944__a.length) {G__38944__a[G__38944__i] = arguments[G__38944__i + 1]; ++G__38944__i;}
  _ = new cljs.core.IndexedSeq(G__38944__a,0,null);
} 
return G__38943__delegate.call(this,rdr,_);};
G__38943.cljs$lang$maxFixedArity = 1;
G__38943.cljs$lang$applyTo = (function (arglist__38945){
var rdr = cljs.core.first(arglist__38945);
var _ = cljs.core.rest(arglist__38945);
return G__38943__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1517117172010
