...
var and__36913__auto__ = !(("#" === ch));
if(and__36913__auto__){
var and__36913__auto____$1 = !(("'" === ch));
if(and__36913__auto____$1){
var and__36913__auto____$2 = !((":" === ch));
...
if(cljs.core.truth_((function (){var and__36913__auto__ = validate_leading_QMARK_;
...
var G__41572 = (function (){var G__41570 = sb;
G__41570.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__41570;
})();
var G__41573 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__41572;
ch = G__41573;
continue;
}
...
var temp__5457__auto____$1 = cljs.tools.reader.edn.dispatch_macros.call(null,ch);
if(cljs.core.truth_(temp__5457__auto____$1)){
var dm = temp__5457__auto____$1;
return dm.call(null,rdr,ch,opts);
} else {
var temp__5457__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__41574 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41574,ch);

return G__41574;
})(),ch,opts);
if(cljs.core.truth_(temp__5457__auto____$2)){
var obj = temp__5457__auto____$2;
return obj;
} else {
...
var or__36925__auto____$1 = cljs.tools.reader.edn.macros.call(null,ch);
...
var vec__41582 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41582,(0),null);
var start_column = cljs.core.nth.call(null,vec__41582,(1),null);
...
var temp__5457__auto__ = cljs.tools.reader.edn.macros.call(null,ch);
if(cljs.core.truth_(temp__5457__auto__)){
var macrofn = temp__5457__auto__;
var mret = macrofn.call(null,rdr,ch,opts);
var G__41586 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__41586;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__41585 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41585,ch);

return G__41585;
})(),true,null,opts);
var G__41587 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__41587;
continue;
}
}
...
var vec__41588 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41588,(0),null);
var start_column = cljs.core.nth.call(null,vec__41588,(1),null);
...
var sb = (function (){var G__41591 = (new goog.string.StringBuffer());
G__41591.append(initch);
...
var G__41593 = (function (){var G__41592 = sb;
G__41592.append(ch);

return G__41592;
})();
var G__41594 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41593;
ch = G__41594;
continue;
}
...
while(true){
var G__41597 = ch;
if(cljs.core._EQ_.call(null,null,G__41597)){
...
if(cljs.core._EQ_.call(null,"\\",G__41597)){
var G__41600 = (function (){var G__41598 = sb;
G__41598.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__41598;
})();
var G__41601 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41600;
ch = G__41601;
continue;
} else {
...
var G__41602 = (function (){var G__41599 = sb;
G__41599.append(ch);

return G__41599;
})();
var G__41603 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41602;
ch = G__41603;
continue;
...
var temp__5459__auto__ = cljs.tools.reader.edn.read_token.call(null,rdr,new cljs.core.Keyword(null,"symbol","symbol",-1038572696),initch);
if(cljs.core.truth_(temp__5459__auto__)){
var token = temp__5459__auto__;
var G__41604 = token;
switch (G__41604) {
case "nil":
return null;
...
break;
default:
var or__36925__auto__ = (function (){var temp__5459__auto____$1 = cljs.tools.reader.impl.commons.parse_symbol.call(null,token);
if(cljs.core.truth_(temp__5459__auto____$1)){
var p = temp__5459__auto____$1;
...
return cljs.core._conj.call(null,(function (){var x__37879__auto____$1 = cljs.tools.reader.edn.read.call(null,rdr,true,null,opts);
...
var G__41607 = rdr;
cljs.tools.reader.edn.read.call(null,G__41607,true,null,true);
...
var temp__5457__auto__ = (function (){var G__41608 = token;
var G__41608__$1 = (((G__41608 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41608));
if((G__41608__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41608__$1);
}
})();
if(cljs.core.truth_(temp__5457__auto__)){
...
var G__41609 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__41609)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__41609)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__41609)){
...
var temp__5457__auto__ = (function (){var or__36925__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"readers","readers",-2118263030).cljs$core$IFn$_invoke$arity$1(opts),tag);
if(cljs.core.truth_(or__36925__auto__)){
return or__36925__auto__;
} else {
...
var temp__5457__auto____$1 = new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(temp__5457__auto____$1)){
var d = temp__5457__auto____$1;
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41616,reader){
...
var eof = cljs.core.get.call(null,map__41617__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
//# sourceMappingURL=edn.js.map?rel=1517117177346
