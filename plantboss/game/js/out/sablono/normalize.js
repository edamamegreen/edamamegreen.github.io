...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__39063_SHARP_){
return ((p1__39063_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__39063_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__39064,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__39064;
}
});
...
var len__38204__auto___39067 = arguments.length;
var i__38205__auto___39068 = (0);
while(true){
if((i__38205__auto___39068 < len__38204__auto___39067)){
args__38211__auto__.push((arguments[i__38205__auto___39068]));

var G__39069 = (i__38205__auto___39068 + (1));
i__38205__auto___39068 = G__39069;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__38212__auto__);
});
...
var G__39066 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__39066,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__39066;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq39065){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39065));
});
...
var vec__39072 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__39072,(0),null);
var names = cljs.core.nth.call(null,vec__39072,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__39072,tag_name,names){
return (function (p1__39070_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__39070_SHARP_));
});})(matches,vec__39072,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__39072,tag_name,names){
return (function (p1__39071_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__39071_SHARP_));
});})(matches,vec__39072,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__39075){
var vec__39076 = p__39075;
var seq__39077 = cljs.core.seq.call(null,vec__39076);
var first__39078 = cljs.core.first.call(null,seq__39077);
var seq__39077__$1 = cljs.core.next.call(null,seq__39077);
var tag = first__39078;
var content = seq__39077__$1;
...
var vec__39079 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__39079,(0),null);
var id = cljs.core.nth.call(null,vec__39079,(1),null);
var class$ = cljs.core.nth.call(null,vec__39079,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1517117172318
